    ...
    module.exports = app => {
        const { existsOrError, notExistsOrErro, equalsOrError } = app.validation   
        ...
        try {
            ...
            existsOrError(user.password, user.confirmaPassword,
                'Senhas não conferem')
        ...
        user.password = encryptoPassword(user.password)
